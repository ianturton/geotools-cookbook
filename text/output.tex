...
\java{../output/src/main/java/org/ianturton/cookbook/output/SaveMapAsImage.java}
...
\begin{mdframed}[linecolor=black, topline=true, bottomline=true,
  leftline=false, rightline=false]
\java{../output/src/main/java/org/ianturton/cookbook/output/WriteShapefile.java}
\end{mdframed}\begin{listing}
